...
//et lance le "timer" en disant que au bout de 30 second timeup = true (si timeup = true alors la function show s'arrete et donc
...
// ------------------------------------------------- TIMER -----------------------------
        ...
        function launch_count_down() { //apelle la function timer
            ...
            // 1- le délai
            let total_delay = 30 * 1000; // toutes les 30 SECONDES
            // 2- Compte à rebours
